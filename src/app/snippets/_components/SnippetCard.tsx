          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="relative group/code">
                <div className="absolute inset-0 p-4 bg-gradient-to-br from-blue-500/15 to-purple-500/5 rounded-lg opacity-0 group-hover/code:opacity-100 transition-all" />
                <pre className="relative bg-black/30 rounded-lg p-4 mb-2 overflow-hidden text-sm text-gray-300 font-mono line-clamp-3">
                  {snippet.code}
                </pre>
              </div>
            </div>
